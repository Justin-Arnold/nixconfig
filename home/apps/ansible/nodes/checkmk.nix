...
in {
  ...
  home.file."${proj}/inventory.ini".text = ''
    [checkmk]
    checkmk.host.internal ansible_user=justin ansible_ssh_private_key_file=/home/justin/.ssh/checkmk_host_key
  '';
  ...
  home.file."${proj}/setup-ssh.yml".text = ''
    ...
    - name: Setup SSH keys from 1Password Connect
      ...
      vars:
        ...
        op_ssh_key_item_name: "ssh-host-checkmk"
        op_connect_token: "{{ lookup('env', 'OP_API_TOKEN') }}"
        ssh_key_path: "/home/justin/.ssh/checkmk_host_key"
